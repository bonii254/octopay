      ...
      <ModalBody className="py-5 px-4 text-center">
        ...
        <div className="mt-4">
          ...
          <p className="text-muted mb-2">
            You are about to delete the leave balance for: <br/>
          ...
          <div className="alert alert-warning border-0 bg-warning-subtle text-warning fs-12 text-start">
            ...
            This action <b>cannot be undone</b>. It will erase historical leave calculations and may affect payroll accruals.
          </div>
          
          <div className="mt-4 text-start">
            <Label className="form-label fs-13">Type <b>DELETE</b> to confirm</Label>
            <Input 
              type="text" 
