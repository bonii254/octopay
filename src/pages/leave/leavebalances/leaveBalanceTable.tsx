...
interface TableProps {
  table: Table<LeaveBalance>;
  isLoading: boolean;
}

const LeaveBalanceTable = ({ table, isLoading }: TableProps) => {
            ...
            <tr>
              <td colSpan={10} className="text-center py-5">
                ...
                <p className="text-muted mb-0">
                  We couldn't find any leave balance matching your current filters.
                </p>
              </td>
            </tr>
          )}
